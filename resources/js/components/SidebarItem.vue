...
const routeMap = {
  ...
  'returns.sales.index': '/returns/sales',
  'returns.sales.create': '/returns/sales/create',
  'returns.purchases.index': '/returns/purchases',
  'returns.purchases.create': '/returns/purchases/create',
  'sales.index': '/sales',
  'sales.create': '/sales/create',
  'payments.index': '/payments',
  'reports.index': '/reports',
  'reports.financial-audit': '/reports/financial-audit',
  ...
  'reports.payables': '/reports/payables',
